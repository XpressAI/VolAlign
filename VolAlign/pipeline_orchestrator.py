...
from .utils import convert_tiff_to_zarr, convert_zarr_to_tiff
...
class MicroscopyProcessingPipeline:
    ...
    def prepare_round_data(self, 
                          ...
                          output_zarr_dir: Optional[str] = None) -> Dict[str, str]:
        """
    ...
    def create_registration_channels(self,
                                   channel_405_path: str,
                                   channel_488_path: str,
                                   output_path: str,
                                   merge_strategy: str = "mean") -> str:
        """
    ...
    def run_registration_workflow(self,
                                 ...
                                 registration_name: str) -> Dict[str, str]:
        """
        ...
        self.create_registration_channels(
            fixed_round_data['405'], fixed_round_data['488'],
            str(fixed_reg_channel)
        )
        
        self.create_registration_channels(
            moving_round_data['405'], moving_round_data['488'],
    ...
    def run_segmentation_workflow(self,
                                 ...
                                 upsample_results: bool = True) -> Dict[str, Any]:
        """
        ...
        segmentation_results = {
            ...
            'downsampled_input': str(downsampled_path) if downsample_for_segmentation else None,
            'downsampled_segmentation': str(segmentation_output) if upsample_results else None
        }
    ...
    def apply_registration_to_all_channels(self,
        ...
        target_channels = [path for name, path in target_round_data.items() 
