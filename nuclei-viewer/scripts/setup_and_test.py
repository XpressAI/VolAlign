...
def update_config(project_root, data_dir):
    ...
    updated_config = config_content.replace(
        'base_path: ""', f'base_path: "{data_dir.absolute()}"'
    )

    # Update array_key to null for direct zarr arrays
    updated_config = updated_config.replace('array_key: "labels"', "array_key: null")
    updated_config = updated_config.replace('array_key: "raw"', "array_key: null")
...
def main():
    ...
    parser.add_argument(
        "--data-dir", type=str, default="test_data", help="Directory for test data"
    )
    parser.add_argument(
        "--skip-backend", action="store_true", help="Skip backend setup"
    )
    parser.add_argument(
        "--skip-frontend", action="store_true", help="Skip frontend setup"
    )
    parser.add_argument(
        "--skip-data", action="store_true", help="Skip test data generation"
    )
    parser.add_argument(
        "--start-server", action="store_true", help="Start the backend server"
    )
